...
// TODO... put this back in after we get Nuget to install Newtonsoft.Json below...
//using Newtonsoft.Json;

using MagicCardAPI.API_DTO;


namespace MagicCardAPI
{
    public class WizardsAPI : IMagicTheGatheringAPI
    {
        #region Members.
        ...
        #region Constructors.
        public WizardsAPI(string basePath)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                using (var response = client.GetAsync(url, HttpCompletionOption.ResponseHeadersRead).Result) // forcing sync
                {
                    ...
                    if (!string.IsNullOrEmpty(jsonString))
                    {
                        ...
                        MagicCardResponse content = null;
